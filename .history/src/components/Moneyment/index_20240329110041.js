...
<CardBody className="bg-[var(--color-secondary)] relative group/card dark:hover:shadow-2xl dark:hover:shadow-[var(--color-primary)]/[0.1] dark:bg-black dark:border-[var(--color-accent)]/[0.2] border-[var(--color-primary)]/[0.1] w-auto sm:w-[30rem] h-auto rounded-xl p-6 border">
