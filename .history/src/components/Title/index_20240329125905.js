            ...
            >
                <div className={styles.title_text}>
                    ...
                    <div className={styles.social_links}>
                        <button>                        <a href='https://www.linkedin.com/in/sara-shiojima-ali/' target="_blank" rel="noopener noreferrer"><u>Let's Connect on LinkedIn</u></a></button>
                        <a href='https://github.com/SaraShio' target="_blank" rel="noopener noreferrer"><u>Check Out My GitHub</u></a>
                    </div>
