            ...
            >
                <div className={styles.title_text}>
                    ...
                    <div className={styles.social_links}>
                        <a href='https://www.linkedin.com/in/sara-shiojima-ali/' target="_blank" rel="noopener noreferrer"><u>LinkedIn</u></a>
                        <a href='https://github.com/SaraShio' target="_blank" rel="noopener noreferrer"><u>GitHub</u></a>
                    </div>
                ...
                <animated.div
                    ...
                    onMouseLeave={() => setSpin({ transform: 'rotateY(360deg)', opacity: 1 })}
                    style={spinProps}
                >
                    <img
