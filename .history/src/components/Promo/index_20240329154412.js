...
export function Promo() {
  ...
  return (
    <div className={styles.promo_container}>
      <h1 ref={titleParallax.ref} className={styles.promo_text}>Contact me for a free consultation!The more time we have to collaborate, the better — so don't hesitate to reach out anytime :)</h1>
